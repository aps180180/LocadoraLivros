        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiasEmprestimo = table.Column<int>(type: "int", nullable: false),
                    ValorDiaria = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ValorSubtotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DataDevolucaoItem = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ValorMultaItem = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmprestimoItens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmprestimoItens_Emprestimos_EmprestimoId",
                        column: x => x.EmprestimoId,
                        principalTable: "Emprestimos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmprestimoItens_Livros_LivroId",
                        column: x => x.LivroId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmprestimoItens_EmprestimoId",
                table: "EmprestimoItens",
                column: "EmprestimoId");

            migrationBuilder.CreateIndex(
                name: "IX_EmprestimoItens_EmprestimoId_LivroId",
                table: "EmprestimoItens",
                columns: new[] { "EmprestimoId", "LivroId" });

            migrationBuilder.CreateIndex(
                name: "IX_EmprestimoItens_LivroId",
                table: "EmprestimoItens",
                column: "LivroId");

            migrationBuilder.CreateIndex(
                name: "IX_Emprestimos_ClienteId_Status",
                table: "Emprestimos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emprestimos_DataPrevisaoDevolucao",
                table: "Emprestimos",
                column: "DataPrevisaoDevolucao");
